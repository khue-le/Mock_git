...
<div class="col-md-2 navbar_teacher">
	<div class="item_navbar_teacher">
		<a href="./student_list_home.html" class="custom_button">
			<img src="./images/home.png" />Home
		</a>
	</div>
	<div class="item_navbar_teacher">
	<%int id = (Integer) request.getSession().getAttribute("idcourse"); %>
		<a href="./student_course.html?id=<%=id %>&mode=list" class="custom_button">
			<img src="./images/course.png" />Schedule
		</a>
	</div>
	<div class="item_navbar_teacher">
		<a href="student_materials.html" class="custom_button">
			<img src="./images/resources.png" />Materials
		</a>
	</div>
	<div class="item_navbar_teacher">
		<a href="./student_Assignments.html" class="custom_button">
